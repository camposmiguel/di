package com.salesianostriana.dam.di.solucionproyectoweather.services;
...
public class GcmRegistrationAsyncTask extends AsyncTask<String, Void, String> {
    ...
    private void sendRegistrationIdToBackend() {
        ...
        try {
            url = new URL("http://weather.miguelcr.com/register.php?regId=" + regId+"&city="+nombreCiudad);
